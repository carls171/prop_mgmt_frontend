...
async function test() {
  ...
  console.log('Testing field order...');
  // We'll use a raw string to ensure order if the server is that primitive
  ...
  try {
    const res = await axios.post(`${API_TARGET}/income/${propertyId}`, body, {
